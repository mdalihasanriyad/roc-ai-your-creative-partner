...
export const ChatMessage = ({ 
  ...
  const handleRegenerate = () => {
    // Extract the image generation prompt from message content or use a default
                            ...
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <button
                                  ...
                                  className="p-2 rounded-md bg-background/80 backdrop-blur-sm hover:bg-background text-foreground shadow-md"
                                >
